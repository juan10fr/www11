    ...
    <?php
        ...
        while ($registro = mysqli_fetch_row($resultado)){
            ...
            echo "<table class='table table-sm text-info'> ";
                echo "<tr><td class='text-right text-warning'>id_evento: </td><td><h5>",$registro[0],"</h5></td></tr>";
        ...
        <div class="row py-1 bg-dark text-info">
            ...
            <div class="col-3 text-center">
                <form action="BorraEvento.php" method="post">
            ...
            <div class="col-3 text-center"> 
                <form action="gestionevento.php" method="post">
                    ...
                    <input type="image" SRC="estilos/BTNCANCELAR.jpg" name="codigo" height="30" ALT="cancelar">
                    </p> 
                </form>
            </div> 
