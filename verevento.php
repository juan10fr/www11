                ...
                if(mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($registro = mysqli_fetch_row($resultado)){
                        ...
                        echo "<table class='table text-info'> ";
                            ...
                            echo "<tr><td class='text-right text-warning'>NICK: </td><td><h5>",$registro[1],"</h5></td></tr>";
                            echo "<tr><td class='text-right text-warning'>CONTRASEÑA: </td><td><h5>",$registro[2],"</h5></td></tr>";
                            echo "<tr><td class='text-right text-warning'>NOMBRE Y APELLIDOS: </td><td><h5>",$registro[3],"</h5></td></tr>";
                            echo "<tr><td class='text-right text-warning'>NIVEL:  </td><td><h5>",$registro[4],"</h5></td></tr>";
                        echo "</table>";
                        echo '</div>';					
                    }
                } else {
