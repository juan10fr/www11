    ...
    <div class="section">
      <div class="container">
		...
		<div class="row text-center">	
            ...
            $tabla="evento";// Escribir entre comillas el nombre de la tabla a listar
			...
			// Formulario para enviar los datos
				echo '<form name="alta" method="POST" action="AltaEventos.php">';
            ...
            while ($registro = mysqli_fetch_row($resultado)){
				...
				echo "<td align='center'>";
					...
					// Formulario para enviar los datos
						echo '<form name="veruno" method="POST" action="verevento.php">';
						echo '<input type="hidden" name="codigo" value="'.$registro[0].'">';
						echo '<input type="image" src="estilos/UnOjo.jpg">';
						echo '</form>';
				echo "</td><td align='center'>";		
					...
					// Formulario para enviar los datos
						...
						echo '<input type="hidden" name="codigo" value="'.$registro[0].'">';
						echo '<input type="image" src="estilos/Borrar.jpg">';
						echo '</form>';
				echo "</td><td align='center'>";		
					// Para modificar un registro.
					// Formulario para enviar los datos
						echo '<form name="modificar-evento" method="POST" action="modificar-evento.php">';
						echo '<input type="hidden" name="codigo" value="'.$registro[0].'">';
						echo '<input type="image" src="estilos/Editar.jpg">';
						echo '</form>';
